            ...
            if not query:
                ...
                with st.status("Engine: Llama 3.3 Versatile Processing...", expanded=True):
                    try:
                        ...
                        sys_prompt = f"Write ONLY python code using plotly.express. Data: 'data.csv'. Columns: {df.columns.tolist()}. Goal: {query}. Force template='plotly_dark'. Final line: 'fig.show()'."
